...
import { View, Text, StyleSheet, Switch, StatusBar, TouchableOpacity, SafeAreaView, ScrollView } from 'react-native'; // Add ScrollView import
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View style={[styles.container, { backgroundColor: colors.background }]}>
          ...
          <View style={styles.section}>
            ...
            <TouchableOpacity style={styles.settingContainer} onPress={() => navigation.navigate('sections/editProfile')}>
            ...
            <TouchableOpacity style={styles.settingContainer} onPress={() => navigation.navigate('sections/changePassword')}>
              <View style={styles.settingLeft}>
            ...
            <TouchableOpacity style={styles.settingContainer} onPress={() => navigation.navigate('sections/updateEmail')}>
              <View style={styles.settingLeft}>
          ...
          {/* Logout Section */}
          <View style={styles.section}>
            <TouchableOpacity style={styles.settingContainer} onPress={handleLogout}>
              <View style={styles.settingLeft}>
                <Icon name="logout" size={24} color="#6200ee" />
